...
error = open("errores_sucre.log","a+")

import glob
for each_origin_file in glob.glob("sucre*"): #(a repetirse para todos los tabs del archivo, exportados en csv: ['sucre_coordinadores.csv', 'sucre_docentes.csv', 'sucre_operativo.csv', 'sucre_triunfadores.csv']
