...
error = open("errores_"+nombre_mision.lower()+".log","a+")

import glob
print "Going to import ",glob.glob("cultura*")
for each_origin_file in glob.glob("cultura*"): #(a repetirse para todos los tabs del archivo, exportados en csv: ['sucre_coordinadores.csv', 'sucre_docentes.csv', 'sucre_operativo.csv', 'sucre_triunfadores.csv']
            ...
            if True:
                ...
                try:
                    if len(l[4])>0:
                        ...
                        beneficiario.update({'fecha_nacimiento':fecha_nacimiento})
                except:
                    print "Error con fecha_nacimiento"
