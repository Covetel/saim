...
beneficiarios = sock.execute(dbname, uid, pwd, 'saim.beneficiario', 'search',[("mision_id","=",mision_id)] )
print beneficiarios
result = sock.execute(dbname, uid, pwd, 'saim.beneficiario', 'unlink',beneficiarios)
